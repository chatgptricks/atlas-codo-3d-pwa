...
const pairing=document.createElement('details');pairing.id='pairing';pairing.innerHTML='<summary>Emparejar con brazo real</summary><p class="note">El tatuaje se usa solo como referencia visual para el reconocimiento de cámara; no se muestra ninguna foto en la app.</p>';document.querySelector('aside')!.insertBefore(pairing,$('camera'));
