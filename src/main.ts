...
const armImage=document.createElement('img');armImage.src='./reference-arm-right.jpg';armImage.alt='Referencia del brazo derecho';armImage.id='arm-reference';$('stage').prepend(armImage);
